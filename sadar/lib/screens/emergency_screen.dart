        ...
        Expanded(
          child: Column(
            ...
            children: [
              ...
              Text(
                '${_contacts.length} contacts · Auto-notified on detection',
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        const SizedBox(height: 2),
                        Text(
                          'Escalate after $_timeoutSetting',
                          style: TextStyle(fontSize: 10, color: _C.textMuted),
                        ),
                      ],
                    ),
      ...
      builder: (_) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Escalate to next contact if no response',
