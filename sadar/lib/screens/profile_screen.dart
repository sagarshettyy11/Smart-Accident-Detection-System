    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Text(
            'ID: SADAR-2024-AK · Member since Jan 2024',
          ...
          Row(
            ...
            children: [
              ...
              _Badge(
                label: 'Pro Plan',
                bg: _C.blueLight.withValues(alpha: 0.12),
              ...
              _Badge(
                label: 'Verified',
                bg: _C.purple.withValues(alpha: 0.12),
                border: _C.purple.withValues(alpha: 0.3),
                color: _C.purple,
              ),
            ],
          ),
      ...
      child: Column(
        children: [
          _InfoRow(
            ...
            iconBg: _C.blueLight.withValues(alpha: 0.1),
            label: 'Camera Model',
            value: 'SADAR Cam Pro v2',
          ),
          _InfoRow(
            icon: Icons.satellite_alt_rounded,
            iconBg: _C.green.withValues(alpha: 0.1),
            label: 'GPS Module',
            value: 'NEO-M8N · 4 Satellites',
          ),
          _InfoRow(
            icon: Icons.memory_rounded,
            iconBg: _C.purple.withValues(alpha: 0.1),
            label: 'Firmware',
            value: 'v2.4.1 (Up to date)',
            isLast: true,
          ),
        ],
      ),
