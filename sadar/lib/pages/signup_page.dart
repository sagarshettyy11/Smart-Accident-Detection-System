        ...
        children: [
          AnimatedContainer(
            ...
            decoration: BoxDecoration(
              ...
              border: Border.all(
                color: _agreedToTerms ? _C.bluePrimary : _C.textMuted,
                width: 1.5,
              ),
            ),
...
class _StepIndicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(
      children: [
        _StepDot(number: 1, label: 'Account', state: _stepState(1)),
        Expanded(child: _StepLine(active: currentStep > 1)),
        _StepDot(number: 2, label: 'Profile', state: _stepState(2)),
        Expanded(child: _StepLine(active: currentStep > 2)),
        _StepDot(number: 3, label: 'Contacts', state: _stepState(3)),
      ],
    );
  }
...
class _StepLine extends StatelessWidget {
  ...
  Widget build(BuildContext context) => Container(
    ...
    decoration: BoxDecoration(
      color: active ? _C.bluePrimary.withValues(alpha: 0.45) : _C.border,
